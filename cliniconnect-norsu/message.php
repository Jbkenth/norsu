<?php 
  ...
  if (isset($_SESSION['idnumber'])) {
	...
	$db = mysqli_connect("$sName", "$uName", "$pass", "$db_name");
	   ...
	   $ses_sql=mysqli_query($db,"select idnumber from users where idnumber='$check'");
    		...
    		<ul id="chatList"
    			...
    			<?php if (!empty($conversations)) { ?>
	    			...
	    			<li class="list-group-item">
	    				<a href="chat.php?user=<?=$conversation['idnumber']?>"
	    				   class="d-flex
	    				          justify-content-between
