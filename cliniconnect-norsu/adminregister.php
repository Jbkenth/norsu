...
<html>
    ...
    <body>
        ...
        <form method="post" action="adminserverregister.php">
            <div class="form">
            <div class="up">
            REGISTER
            </div>
			...
			?>
                ...
                <input class="input" placeholder="Type here..."  value="<?=$adminname?>" name="adminname" type="text" />
                <div class="label">
                <label>Admin Password:</label>
            </div>
                <input class="input" placeholder="Type here..." type="text"name="adminpassword" value="<?=$adminpassword?>" />
                <div class="label">
                <button class="btn" type="submit">Submit</button>
                <p>Have an account? <a href="adminlogin.php">Login</a></p>
            </div>
            </div>
        </form>
    </body>
